...
export const usedPairs: {
  ...
  { fg: "focus", bg: "bg-subtle", large: true, note: "focus ring on a wash" },
  {
    ...
    bg: "bg-subtle",
    large: true,
    note: "critical severity dot",
  },
  { fg: "sev-high", bg: "bg-subtle", large: true, note: "high severity dot" },
  {
    fg: "sev-medium",
    bg: "bg-subtle",
    large: true,
    note: "medium severity dot",
  },
  { fg: "sev-low", bg: "bg-subtle", large: true, note: "low severity dot" },
  { fg: "sev-info", bg: "bg-subtle", large: true, note: "info severity dot" },
];
